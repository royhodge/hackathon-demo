  ...
  <div class="page-container unselectable">
    <md-app md-waterfall md-mode="fixed-last">
      <md-app-toolbar class="md-large md-dense md-primary tool-bar">
        <div class="md-toolbar-row">
          <div class="md-toolbar-section-start">
            ...
            <span class="md-title unselectable car">Blockchain Kennel Club Demo</span>
          </div>
          ...
          <md-dialog class="wallet" :md-click-outside-to-close=false :md-active.sync="isWallet">
            <md-toolbar class="md-accent md-dense">
              <h3 class="md-title" style="flex: 1">BKC Wallet</h3>
            ...
            <div v-if="isRestore">
              <div class="wallet-content">
                <div class="md-subheading">
                  Restore your BKC Account with Seed
                </div>
                <br>
            ...
            <div v-if="isCheck">
              <div class="wallet-content">
                <div class="md-subheading">
                  Blockchain Kennel Club Account Information
                </div>
                <br>
        ...
        <div class="md-toolbar-row">
          <md-tabs class="md-primary">
            ...
            <md-tab id="Post" md-label="Post Record" to="Post"></md-tab>
            <md-tab id="Get" md-label="Get Record" to="Get"></md-tab>
          </md-tabs>
        </div>
      </md-app-toolbar>
      ...
      <md-app-drawer :md-active.sync="menuVisible">
        ...
        <div class="md-subheading title">Blockchain Kennel Club</div>
        <md-list>
        ...
        <div class="md-layout love">
          ...
          <div>@ <a href="https://wyohackathon.io">WyoHackathon</a></div>
        </div>
      </md-app-drawer>
